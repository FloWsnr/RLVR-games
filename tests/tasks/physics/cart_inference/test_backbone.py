...
def test_backbone_measurement_updates_budget_and_resets(
    cart_backbone: CartInferenceBackbone,
    ...
    assert backbone.measurements_remaining == cart_config.action_budget - 1
...
def test_backbone_enforces_measurement_action_budget(
    cart_backbone: CartInferenceBackbone,
    cart_config: CartInferenceConfig,
) -> None:
    backbone = cart_backbone
